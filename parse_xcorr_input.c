...
/*	Changed includes for gmtsar-gpu 						*
 *  Diego Romano Jul, 27 2021								*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <math.h>
...
void parse_command_line(int na, char **a, struct xcorr *xc, int *nfiles, int *input_flag, const char *USAGE)
{
int	n;
FILE	*inputfile;
char	tmp[128];
...
struct	PRM *r;
	...
	if (debug) fprintf(stderr,"handle_prm2 %d\n", nfiles);
